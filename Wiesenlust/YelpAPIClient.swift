...
struct YelpAPIConsole {
    var consumerKey = "CrC1bizjj2IMop0NDbCkvg"
    var consumerSecret = "iGpuafDEOIiAUZAuNF5ZavY3IBs"
    var accessToken = "qHJmRH7jS7HM3ZS591Mcjg-_hJypzfqI"
    var accessTokenSecret = "tYe8vJkz-Ix4vOH6JbUOPoUstG4"
}
...
class YelpAPIClient: NSObject {
    ...
    */
    ...
    func checkIn(businessId: String, localeParameters: Dictionary<String, String>? = nil, successSearch: (data: NSData, response: NSHTTPURLResponse) -> Void, failureSearch: (error: NSError) -> Void) {
